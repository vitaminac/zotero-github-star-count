...
ghstar-update-all =
  .label = Update All Github Star Counts.
...
ghstar-invalidGoogleScholarURL = The Github API URL appears malformed; please check "Settings > Github Star Count" to verify your Github API URL.
